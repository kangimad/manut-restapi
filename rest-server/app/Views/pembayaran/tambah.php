     ...
     <div class="section-body">
          <div class="card">
               <div class="card-header">
                    ...
                    <h4 class="ml-2">Daftar Pembayaan / Create</h4>
               </div>

               <div class="card-body">
                    <form action="<?= site_url('pembayaran') ?>" method="post" autocomplete="off">
                         <div class="form-group row">
                              <label for="nama_pmb" class="col-sm-2 col-form-label">Nama Pembayaran</label>
                              <div class="col-sm-9">
                                   <input type="text" class="form-control" id="nama_pmb" placeholder="masukkan nama_pmb" name="nama_pmb" required autofocus>
                              </div>
                         </div>
                         <div class="form-group row">
